...
import { ArrowLeft, ArrowRight, Building2, Check, Film, MapPin, Sparkles, UserRound } from "lucide-react";
        ...
        {step === "welcome" && (
          <div className="flex w-full items-center justify-between gap-12">
            ...
            <aside aria-label="ScoutAI powers" className="hidden w-[min(34vw,24rem)] shrink-0 flex-col gap-3 lg:flex">
              <div className="flex items-center justify-between border-b border-border pb-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-foreground-muted"><span>ScoutAI powers</span><span className="font-mono tracking-normal text-foreground/50">LIVE VIEW</span></div>
